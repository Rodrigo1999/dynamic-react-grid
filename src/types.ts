...
type mapPropsBase = {
    [Property in keyof PropsBase]: PropsBase[Property] | { [key: string]: PropsBase[Property] }
};
...
export interface PropsMedia extends Props {
    _wrap?: Props['wrap'],
    breakpoints: Breakpoints & { [key: string]: number },
}

export type ReturnGrid = React.ForwardRefExoticComponent<React.PropsWithoutRef<Props> & JSX.IntrinsicElements['div'] & { [x: string]: any }>